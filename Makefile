...
compile:
	g++ -Os -I src -I include -c src/States/*.cpp include -c src/Engine/*.cpp include -c src/Engine/Networking/*.cpp include -c src/Engine/GUI/*.cpp include -c src/*.cpp include -c include/SFML/Graphics/*.cpp -c src/Item/*.cpp
link:
